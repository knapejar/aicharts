...
Sample datasets used by snapshots and scenario tests. Each file is pure data, no logic.
...
- `election-results.json` — party share by region
- `edge-single-point.json` — single data point
- `edge-extreme-range.json` — values from 1 to 1e12
